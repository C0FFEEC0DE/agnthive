...
export async function runMain(env, opts = {}) {
  ...
  const appName = envOrDefault(env, 'OPENROUTER_APP_NAME', 'agnthive-benchmark');
  ...
  const guideMd = readTextIfExists(join(repoRoot, 'plugins', 'agnthive', 'README.md'));
